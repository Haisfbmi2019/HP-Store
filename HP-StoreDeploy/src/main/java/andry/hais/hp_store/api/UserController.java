...
import andry.hais.hp_store.component.UserIdentity;
import andry.hais.hp_store.config.JWT.JwtProvider;
import andry.hais.hp_store.entity.User;
import andry.hais.hp_store.service.UserService;
import andry.hais.hp_store.vo.request.LoginForm;
import andry.hais.hp_store.vo.response.JwtResponse;
...
public class UserController {
    ...
    public ResponseEntity<User> test(@PathVariable("email") String email) {
